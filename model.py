...
def get_model(model_name):
    if model_name == "VGG":
        ...
        return VGG(conv_arch, 3)
    elif model_name == 'InceptionResNetV2':
        return InceptionResNetV2(num_classes=2)
    elif model_name == 'ResNet50':
        return ResNet50(num_classes=2)
    elif model_name == 'ResNet34':
        return ResNet34(num_classes=2)
...
class VGG(nn.Module):
    def __init__(self, conv_arch, in_channels):
        ...
        self.model = nn.Sequential(*layers, nn.Flatten(),
                                   nn.Linear(out_channels * 16 * 16, 4096),
                                   nn.ReLU(),
                                   #    nn.Dropout(0.5),
                                   nn.Linear(4096, 4096),
                                   nn.ReLU(),
